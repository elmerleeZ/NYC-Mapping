...
setwd("/Users/zongyangli/Google Drive/Job/RA - Public Good/Public Good Code_Resources - Copy/R Code - Elmer/UJA_Mapping")


# Data to load in
schools <- read.csv("/Users/zongyangli/Google Drive/Job/RA - Public Good/Public Good Code_Resources - Copy/R Code - Elmer/UJA_Mapping/data/Data_2015_2016_full.csv")
re_comps <- read.csv("/Users/zongyangli/Google Drive/Job/RA - Public Good/Public Good Code_Resources - Copy/R Code - Elmer/UJA_Mapping/data/re_comps.csv")
source("/Users/zongyangli/Google Drive/Job/RA - Public Good/Public Good Code_Resources - Copy/R Code - Elmer/UJA_Mapping/data/map_supplements.R")
...
ui <- shinyUI(navbarPage("Brooklyn Jewish Organizations", theme = shinytheme("sandstone"), 
                         ...
                         absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                      ...
                                      checkboxGroupInput(inputId = "selected_locs", 
                                                         label = h2("Eligibility"), 
                                                         choices = as.list(unique(schools$Eligibility)), 
                                                         selected = "Dist1"), 
                         ...
                         tabPanel("Organization Information", dataTableOutput("mytable"))
                         ))
...
server <- function(input, output) {
  ...
  observe({
    ...
    leafletProxy("brooklynmap") %>% clearMarkers() %>% clearShapes() %>%
      addAwesomeMarkers(icon = icon1, 
                        ...
                        ~Lat, 
                        label = ~School.Name, 
                        popup = paste("Name: ", district_1()$School.Name, "<br/>",  "<br/>",
                                      "Eligibility: ", district_1()$Eligibility, "<br/>",  "<br/>",
                                      "Selection Criteria: ", district_1()$selection.criteria, "<br/>", "<br/>",
                                      "Admission Priorities: ", district_1()$admissions.priorities)) %>% 
      ...
      addAwesomeMarkers(icon = icon2, 
                        ...
                        ~Lat, 
                        label = ~School.Name, 
                        popup = paste("Name: ", district_2()$School.Name, "<br/>",  "<br/>",
                                      "Eligibility: ", district_2()$Eligibility, "<br/>",  "<br/>",
                                      "Selection Criteria: ", district_2()$selection.criteria, "<br/>", "<br/>",
                                      "Admission Priorities: ", district_2()$admissions.priorities)) %>%
      ...
      addAwesomeMarkers(icon = icon3, 
                        ...
                        ~Lat, 
                        label = ~School.Name, 
                        popup = paste("Name: ", borough_wide()$School.Name, "<br/>",  "<br/>",
                                      "Eligibility: ", borough_wide()$Eligibility, "<br/>",  "<br/>",
                                      "Selection Criteria: ", borough_wide()$selection.criteria, "<br/>", "<br/>",
                                      "Admission Priorities: ", borough_wide()$admissions.priorities)) %>%
      ...
      addAwesomeMarkers(icon = icon4, 
                        ...
                        ~Lat, 
                        label = ~School.Name, 
                        popup = paste("Name: ", city_wide()$School.Name, "<br/>",  "<br/>",
                                      "Eligibility: ", city_wide()$Eligibility, "<br/>",  "<br/>",
                                      "Selection Criteria: ", city_wide()$selection.criteria, "<br/>", "<br/>",
                                      "Admission Priorities: ", city_wide()$admissions.priorities)) %>%
  ...
  Lon <- -90
  School.Name <- "Org"
  empty_df <- data.frame(Lat, Lon, School.Name)
  ...
  district_1 <- reactive({
    if(!("Dist1" %in% input$selected_locs)){
      return(empty_df)
    }
    else{
      return(schools[schools$Eligibility == "Dist1", ])
    }
  })
  
  district_2 <- reactive({
    if(!("Dist2" %in% input$selected_locs)){
      return(empty_df)
    }
    else{
      return(schools[schools$Eligibility == "Dist2", ])
    }
  })
  
  borough_wide <- reactive({
    if(!("Borough-wide" %in% input$selected_locs)){
      return(empty_df)
    }
    else{
      return(schools[schools$Eligibility == "Borough-wide", ])
    }
  })
  
  city_wide <- reactive({
    if(!("City-wide" %in% input$selected_locs)){
      return(empty_df)
    }
    else{
      return(re_comps)
  ...
  output$mytable = DT::renderDataTable({
    schools2 <- select(schools, School.Name, Eligibility, 
                         Address, selection.criteria, 
                          admissions.priorities, Phone.Number, Email)
    colnames(schools2) <- c("Organization", "Category", 
                              "Address", "Purpose", 
